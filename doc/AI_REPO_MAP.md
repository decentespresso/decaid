...
- `assets/plugins/weather.reaplugin/` — generated from the pinned [ChampionDesigns/decaid-weather-plugin](https://github.com/ChampionDesigns/decaid-weather-plugin) release by `scripts/fetch_weather_plugin.sh`. Do weather behavior work in that repository, not against the generated Decaid asset.
