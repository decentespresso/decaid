...
| GET | `/api/v1/diagnostics/ble` | Read-only BLE state, raw/valid sample ages, queue generations/operations, and latest failure with peer state | `ble_diagnostics_handler.dart` |
